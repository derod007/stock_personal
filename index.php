      ...
      <aside class="global-help" id="global-help" role="dialog" aria-labelledby="global-help-title" hidden>
        ...
        <section class="global-help__section">
          ...
          <dl>
            ...
            <div>
              <dt>거래대금</dt>
              <dd>주가와 거래량을 곱한 실제 매매 규모입니다. 순위는 다음 금융 거래대금 순입니다. 스팩, ETF, ETN, 단일종목 레버리지는 빼고 다음 종목으로 채웁니다. 거래량 순위와 다릅니다.</dd>
            </div>
            <div>
              <dt>거래대금 스캔(코스피)</dt>
        ...
        <div>
          <h2>
            ...
            <?= tip(($scanMarket === 'kospi'
                ? "코스피 거래대금 상위에 구조 점수를 붙입니다. 스팩, ETF, ETN, 단일종목 레버리지는 빼고 다음 종목으로 채웁니다."
                : "코스피·코스닥 거래대금 상위에 구조 점수를 붙입니다. 스팩, ETF, ETN, 단일종목 레버리지는 빼고 다음 종목으로 채웁니다.")
                . "
